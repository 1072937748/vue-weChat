<template>
	<section class="child_page">
		<head-top crossover="关于聊天室"></head-top>
		<section class="aboutwx">
			...
			<section class="aboutwx_title">聊天室 6.5.7</section>
		</section>
		...
		<section class="agreement">
			<div class="agreement_top">
				<a href="https://weixin.qq.com/agreement?lang=zh_CN">《通讯软件许可服务协议》</a>和
				<a href="http://www.qq.com/privacy.htm">《XX隐私政策》</a>
			</div>
